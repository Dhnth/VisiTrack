...
export async function GET() {
  ...
  const worksheet = workbook.addWorksheet('Template Petugas');
  ...
  const examples = [
    { name: 'Budi Petugas', email: 'budi.petugas@example.com' },
    { name: 'Siti Petugas', email: 'siti.petugas@example.com' },
  ];
  ...
  return new NextResponse(buffer, {
    headers: {
      ...
      'Content-Disposition': 'attachment; filename="template_petugas.xlsx"',
    },
  });
}