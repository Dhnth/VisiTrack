...
const menuItems = [
  ...
  { name: "Ranking Karyawan", href: "/employee", icon: TrendingUp },
  { name: "History Kunjungan", href: "/history", icon: History },
  { name: "Laporan & Export", href: "/export", icon: Download },
];

interface PpidClientLayoutProps {
...
export default function PpidClientLayout({
  children,
  slug,
  instanceName,
  instanceLogo,
  ...
  const getHref = (href: string) => `/${slug}/ppid${href}`;

  const isActiveLink = (href: string) => {
    if (href === "/") {
      return pathname === `/${slug}/ppid`;
    }
        ...
        <header className="bg-white shadow-sm px-4 sm:px-6 py-3 flex items-center justify-between border-b border-gray-100">
          <div className="flex items-center gap-3">
            ...
            <div className="hidden sm:block">
              ...
              <p className="text-xs text-gray-400">PPID Panel</p>
            </div>
            <span className="px-2 py-0.5 text-xs font-medium bg-purple-100 text-purple-700 rounded-full whitespace-nowrap">
              PPID
            </span>
          </div>
          <div className="flex items-center gap-2 sm:gap-4">
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              <div className="text-right hidden sm:block">
                <p className="text-sm font-medium text-gray-700">{ppidName}</p>
                <p className="text-xs text-gray-400">{ppidEmail}</p>
              </div>
